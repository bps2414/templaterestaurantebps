...
(function () {
    ...
    function applyStoreStatus(open) {
        ...
        if (open) {
            ...
            document.querySelectorAll('.order-btn[disabled]').forEach(function (btn) {
                btn.disabled = false;
                btn.style.opacity = '';
                btn.style.cursor = '';
            });
            ...
            if (cartToggle) {
                ...
                cartToggle.style.opacity = '';
                cartToggle.style.cursor = '';
            }
        } else {
            ...
            if (cartToggle2) {
                cartToggle2.disabled = true;
                cartToggle2.style.opacity = '0.5';
                cartToggle2.style.cursor = 'not-allowed';
            }
        }
    ...
    document.addEventListener('click', (e) => {
        ...
        if (document.body.dataset.storeClosed === 'true') {
            if (window.feedback) {
                window.feedback.error('Estamos fechados no momento. Volte no horário de funcionamento! 🕐');
            }
            e.preventDefault();
            e.stopPropagation();
            return;
