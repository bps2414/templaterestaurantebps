...
export async function seedPizzaria() {
    ...
    const dishes = [
        ...
        },
        {
            ...
            price: 6490,
            image: 'https://images.unsplash.com/photo-1559978137-8c560d91e9e1?w=600&q=80',
            categoryId: especiais.id,
            featured: false,
            sortOrder: 2,
        },
        {
            ...
            price: 5490,
            image: 'https://images.unsplash.com/photo-1600628421060-939639517883?w=600&q=80',
            categoryId: especiais.id,
            featured: false,
            sortOrder: 3,
        },
        {
            ...
            price: 4590,
            image: 'https://images.unsplash.com/photo-1511689660979-10d2b1aada49?w=600&q=80',
            categoryId: especiais.id,
            featured: false,
            sortOrder: 4,
        },
    ...
    if (validPlan === 'professional') {
        configs.team_members = JSON.stringify([
            { name: 'Giovanni Rossi', role: 'Pizzaiolo Chefe', image: 'https://images.unsplash.com/photo-1583394293214-28ded15ee548?w=400&h=400&fit=crop' },
            { name: 'Maria Fernanda', role: 'Confeiteira', image: 'https://images.unsplash.com/photo-1595273670150-bd0c3c392e46?w=400&h=400&fit=crop' },
        ]);
    }
